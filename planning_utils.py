...
def create_grid(data, drone_altitude, safety_distance):
    ...
    """
     Most of the code based on class room exercises. Added two more return values for 
     north_min and east_min
    """
...
class Action(Enum):
    ...
    """
    most of the code based on class room exercises. 
    Added north_west, north_east, south_west and south_east actions. 
    Cost of these actions is based on sqrt of dist
    """
...
def a_star(grid, h, start, goal):
    ...
    """
    a* implementation based on class room exercises
...
def plot_route(grid, path, start_ne, goal_ne, pruned):

    """
    plots the route on a chart
    """
    ...
    if pruned:
        fig.savefig('charts/plan_route_pruned.png', bbox_inches='tight')
    else:
        fig.savefig('charts/plan_route.png', bbox_inches='tight')